...
export function scanTsFile(content: string, filePath: string): DependencyNode[] {
...
function extractTables(captured: string, fullMatch: string): string[] {
