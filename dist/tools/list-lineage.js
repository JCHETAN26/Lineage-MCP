import { z } from "zod";
import { getDependenciesForTable, getDependenciesForColumn, buildLineageTree, getTableNames, } from "../graph.js";
...
export function listLineage(input, graph) {
...
export function listAllTables(graph) {
    return getTableNames(graph);
}
//# sourceMappingURL=list-lineage.js.map